...
const locations = [
  {
    ...
    images: ["/assets/outils/cat.jpg", "/assets/outils/cat.jpg", "/assets/outils/cat.jpg", "/assets/outils/cat.jpg", "/assets/outils/cat.jpg"],
  },
  {
    lat: 35.6892,
    lng: -5.0116,
...
const customIcon = new L.Icon({
  iconUrl: "/assets/outils/marker-icon.png", // Path to your local icon image
