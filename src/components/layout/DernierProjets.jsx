  ...
  return (
    <section className="flex flex-col items-center py-12">
      ...
      <div className="flex justify-evenly mt-24 w-full phone:flex-col phone:items-center phone:gap-6">
        <DernierProjectCard text={t("project1_desc")} img="/Fa3ilKhair/assets/media/dernierProjets.jpg" />
        <DernierProjectCard text={t("project2_desc")} img="/Fa3ilKhair/assets/media/dernierProjets2.jpg" />
        <DernierProjectCard text={t("project3_desc")} img="/Fa3ilKhair/assets/media/dernierProjets3.jpg" />
      </div>
    </section>
  );
}
